      ...
      <div className="w-full max-w-2xl">
        ...
        >
            ...
            >
              ...
              <div className="mb-4 flex flex-row">
                <div className="w-full">
                  ...
                  <select
                    className={`shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline`}
                    {...register(`macchinario.${index}.operatore`)}
                    onFocus={() =>
                      handleFocus(`macchinario.${index}.operatore`)
                    }
                    onBlur={() => handleBlur(`macchinario.${index}.operatore`)}
                  >
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              type="button"
              className="bg-blue-500 hover:bg-blue-700 text-sm w-[100px] lg:w-[175px] lg:text-base text-white px-1 lg:p-2 rounded"
              onClick={() =>
                append({
                  regione: "",
                  operatore: "",
