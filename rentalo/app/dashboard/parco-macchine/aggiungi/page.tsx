            ...
            <div className="flex flex-row w-full space-x-[30px] mb-6">
              ...
              <div className="w-1/2">
                <div className="flex relative flex-row items-center">
                  ...
                  <span className="display-on-hover absolute top-0 lg:top-[5px] left-[-20px] z-10 left-full ml-2 w-[80px] lg:w-[220px] p-2 text-white mt-[-10px] bg-gray-400 text-xs rounded-lg shadow">
