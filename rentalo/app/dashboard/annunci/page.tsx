    ...
    <DashboardLayout>
      <div className="flex flex-col items-center h-full text-textSettings bg-settings py-2 px-4 lg:px-0">
        <div className="flex flex-col items-center justify-center mt-[155px] lg:mt-[200px] w-full lg:w-1/2 rounded h-[350px] p-[10px] lg:p-[40px] bg-white">
          ...
          <h2 className="text-md mb-10 ">Gestisci i tuoi annunci</h2>
          <div className="flex flex-row mb-4">
            <Link href="/dashboard/annunci/crea" className="mr-5 lg:mr-10">
              <button className="bg-blue-500 w-[140px] hover:bg-blue-700 text-sm lg:text-base text-white font-bold py-2 px-4 rounded">
                Crea annuncio
              </button>
            </Link>
            <Link href="/dashboard/annunci/gestisci">
              <button className="bg-blue-500 w-[140px] hover:bg-blue-700 text-sm lg:text-base text-white font-bold py-2 px-4 rounded">
                Gestisci
              </button>
            </Link>
